...
class SignUpView(View):
    ...
    def post(self, request):
        try:
            ...
            user = User.objects.create_user(username=post_value['email'], email=post_value['email'], password=post_value['password'],
                                            first_name=post_value['first_name'], last_name=post_value['last_name'],
                                            is_active=1)
